...
var file_conf_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x65, 0x42, 0x38,
	0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x79, 0x66,
	0x63, 0x6f, 0x2f, 0x66, 0x6f, 0x72, 0x75, 0x6d, 0x2f, 0x7b, 0x7b, 0x2e, 0x50, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x7d, 0x7d, 0x2f, 0x7b, 0x7b, 0x2e, 0x53, 0x72, 0x76, 0x7d, 0x7d, 0x2f, 0x63,
...
var file_conf_proto_goTypes = []interface{}{
	(*Bootstrap)(nil),           // 0: kratos.apis.Bootstrap
	(*Server)(nil),              // 1: kratos.apis.Server
	(*Data)(nil),                // 2: kratos.apis.Data
	(*Trace)(nil),               // 3: kratos.apis.Trace
	(*Registry)(nil),            // 4: kratos.apis.Registry
	(*Server_HTTP)(nil),         // 5: kratos.apis.Server.HTTP
	(*Server_GRPC)(nil),         // 6: kratos.apis.Server.GRPC
	(*Data_Database)(nil),       // 7: kratos.apis.Data.Database
	(*Data_Redis)(nil),          // 8: kratos.apis.Data.Redis
	(*Registry_Consul)(nil),     // 9: kratos.apis.Registry.Consul
	(*durationpb.Duration)(nil), // 10: google.protobuf.Duration
}
var file_conf_proto_depIdxs = []int32{
	3,  // 0: kratos.apis.Bootstrap.trace:type_name -> kratos.apis.Trace
	1,  // 1: kratos.apis.Bootstrap.server:type_name -> kratos.apis.Server
	2,  // 2: kratos.apis.Bootstrap.data:type_name -> kratos.apis.Data
	5,  // 3: kratos.apis.Server.http:type_name -> kratos.apis.Server.HTTP
	6,  // 4: kratos.apis.Server.grpc:type_name -> kratos.apis.Server.GRPC
	7,  // 5: kratos.apis.Data.database:type_name -> kratos.apis.Data.Database
	8,  // 6: kratos.apis.Data.redis:type_name -> kratos.apis.Data.Redis
	9,  // 7: kratos.apis.Registry.consul:type_name -> kratos.apis.Registry.Consul
	10, // 8: kratos.apis.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	10, // 9: kratos.apis.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	10, // 10: kratos.apis.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	10, // 11: kratos.apis.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
